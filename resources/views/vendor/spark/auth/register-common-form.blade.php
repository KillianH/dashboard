<form class="form-horizontal" role="form">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('email')}">
        ...
        <div class="col-md-6">
            <input type="email" class="form-control" name="email" id="email" v-model="registerForm.email">
    ...
    <div class="form-group" :class="{'has-error': registerForm.errors.has('password')}">
        ...
        <div class="col-md-6">
            <input type="password" class="form-control" name="password" id="password" v-model="registerForm.password">
            ...
            <div class="col-md-6 col-md-offset-4">
                <div class="checkbox">
                    <label>
                        ...
                        I Accept The <a href="/terms" rel="noopener">Terms Of Service</a>
                    </label>
